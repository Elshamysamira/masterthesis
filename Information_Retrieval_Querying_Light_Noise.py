...
output_folder = "results_0.6_temperature/results_openai/crosslingual/light_errors"
...
output_csv = os.path.join(output_folder, "german_english_noisy_queries_noisy_documents_light_results.csv")
df.to_csv(output_csv, index=False, encoding="utf-8-sig", sep=";")
