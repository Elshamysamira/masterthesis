...
output_folder = "results_0.6_temperature/results_cohere/monolingual/moderate_errors"
os.makedirs(output_folder, exist_ok=True)  # Create folder if it doesn't exist

output_csv = os.path.join(output_folder, "german_german_noisy_queries_clean_documents_moderate_results.csv")
...
# Save to CSV inside "results" folder
output_folder = "results_0.6_temperature/results_labse/monolingual/moderate_errors"
os.makedirs(output_folder, exist_ok=True)  # Create folder if it doesn't exist
...
# Save to CSV inside "results" folder
output_folder = "results_0.6_temperature/results_openai/monolingual/moderate_errors"
os.makedirs(output_folder, exist_ok=True)  # Create folder if it doesn't exist
