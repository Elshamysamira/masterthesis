...
output_folder = "results_0.6_temperature/results_openai/crosslingual/severe_errors"
os.makedirs(output_folder, exist_ok=True)  # Create folder if it doesn't exist

output_csv = os.path.join(output_folder, "german_english_noisy_queries_clean_documents_severe_results.csv")
...
output_csv = os.path.join(output_folder, "german_english_noisy_queries_noisy_documents_severe_results.csv")
df.to_csv(output_csv, index=False, encoding="utf-8-sig", sep=";")
