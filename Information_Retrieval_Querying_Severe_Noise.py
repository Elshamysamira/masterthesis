...
noisy_queries_file = "queries/noisy_queries_severe_german/noisy_queries_severe_german.txt"  # Adjust path if necessary
...
output_folder = "results_0.6_temperature/results_cohere/monolingual/severe_errors"
os.makedirs(output_folder, exist_ok=True)  # Create folder if it doesn't exist

output_csv = os.path.join(output_folder, "german_german_noisy_queries_clean_documents_severe_results.csv")
...
# Save to CSV inside "results" folder
output_folder = "results_0.6_temperature/results_labse/monolingual/severe_errors"
os.makedirs(output_folder, exist_ok=True)  # Create folder if it doesn't exist
...
# Save to CSV inside "results" folder
output_folder = "results_0.6_temperature/results_openai/monolingual/severe_errors"
os.makedirs(output_folder, exist_ok=True)  # Create folder if it doesn't exist
