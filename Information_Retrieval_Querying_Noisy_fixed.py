...
output_folder = "results_0.4_temperature/results_labse/crosslingual/light_errors"
os.makedirs(output_folder, exist_ok=True)  # Create folder if it doesn't exist

output_csv = os.path.join(output_folder, "german_english_clean_queries_noisy_documents_results.csv")
